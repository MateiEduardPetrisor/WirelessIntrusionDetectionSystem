...
#define WINDOW_SENSOR_ADDRESS 3 // door node address
byte windowSensorPin = 6;
...
RHReliableDatagram manager(driver, WINDOW_SENSOR_ADDRESS);
...
float getSensorValue() {
  return (float)digitalRead(windowSensorPin);
}
