...
#define GAS_SENSOR_ADDRESS 4      // gas node address
byte gasSensorPin = 6;
const int batteryPin = A0;
const char sType[4] = "GAS";
// ~~~ END OF CONSTANTS ~~~
...
RHReliableDatagram manager(driver, GAS_SENSOR_ADDRESS);
...
float getSensorValue() {
  return (float)digitalRead(gasSensorPin);
}
